...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tActions = '<div class="file-actions">\n' +
                ...
                '<div class="clearfix"></div>';
            //noinspection HtmlUnknownAttribute
            tActionDelete = '<button type="button" class="kv-file-remove fas fa-trash {removeClass}" ' +
                'title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n';
            tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
                '{uploadIcon}</button>';
            tActionDownload = '<a class="kv-file-download {downloadClass}" title="{downloadTitle}" ' +
                'href="{downloadUrl}" download="{caption}" target="_blank">{downloadIcon}</a>';
            tActionZoom = '<button type="button" class="kv-file-zoom fas fa-expand {zoomClass}" ' +
			...
			var d = new Date();
            tPdf = '<embed class="kv-preview-data file-preview-pdf" src="{data}?'+d.getTime()+'" type="application/pdf"' + tStyle + '>\n';
	...
	var d = new Date();
    var IFRAME_ATTRIBS = 'class="kv-preview-data file-preview-pdf" src="{renderer}?file={data}?'+d.getTime()+'" {style}';
    ...
    $.fn.fileinput.defaults = {
        ...
        pdfRendererUrl: '',
        pdfRendererTemplate: '<iframe id="framepreview" ' + IFRAME_ATTRIBS + '></iframe>'
    };
