...
Route::get('/trainingform/sort/{id}','App\Http\Controllers\TrainingFormsController@sort');
...
Route::get('/trainingform/trainingformpdf/{id}/trainingform','App\Http\Controllers\TrainingFormsController@trainingformpdf');
...
Route::group(['middleware' => 'auth', 'middleware' => 'isAdmin'], function()
{
    ...
    Route::post('/trainingform/updseq', 'App\Http\Controllers\TrainingFormsController@updseq')->name('trainingform.updseq');
    Route::post('/trainingform/updseq2', 'App\Http\Controllers\TrainingFormsController@updseq2')->name('trainingform.updseq2');
    Route::get('/trainingform/formdetail', 'App\Http\Controllers\TrainingFormsController@detailList')->name('trainingform.formdetail');
    Route::get('/trainingform/trainingformlist', 'App\Http\Controllers\TrainingFormsController@trainingformList')->name('trainingform.trainingformlist');
    Route::post('/trainingform/{id}', 'App\Http\Controllers\TrainingFormsController@update')->name('trainingform.update');
    Route::resource('trainingform',App\Http\Controllers\TrainingFormsController::class);
    ...
    Route::post('/report/cancelsales', 'App\Http\Controllers\ReportCancelSalesController@reportpdf')->name('report.cancelsales');
    Route::get('/report/creditnote', 'App\Http\Controllers\ReportCreditNotesController@index')->name('report.creditnote');
    Route::post('/report/creditnote', 'App\Http\Controllers\ReportCreditNotesController@reportpdf')->name('report.creditnote');
