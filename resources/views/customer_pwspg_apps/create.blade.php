...
@section('content')
    <div class="container-fluid">
        <div class="container">
            ...
            <form id="pwspgappform" method="post" action="{{ route('customer-pwspg-app.store') }}" >
                @csrf

                <div class="row form-group">
                    <div class="col-6">
                        <label for="username">User ID:</label>
                        <input type="text" seq="1" class="form-control enterseq" id="username" name="username"  value="{{ old('username') }}"  maxlength="30" onkeypress="return js_validate_alphanumeric(event);"/>
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="2" class="form-control enterseq" id="password" name="password" maxlength="30" value="{{ old('password') }}" />
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="3" class="form-control enterseq" id="mob_pho" name="mob_pho" maxlength="20" value="{{ old('mob_pho') }}" />
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="4" class="form-control enterseq" id="first_name" name="first_name" maxlength="30" value="{{ old('first_name') }}" />
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="5" class="form-control enterseq" id="idle_tim" name="idle_tim" maxlength="5"/>
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="6" class="form-control enterseq" id="access_pdf" name="access_pdf" maxlength="1"/>
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="7" class="form-control enterseq" id="email" name="email" maxlength="30"/>
...
{{--                                data-url="{{ action('App\Http\Controllers\CustomerPGAppsController@customerlist') }}" autocomplete="off"></select>--}}
                        <select class="form-control customerAutoSelect enterseq overflow-ellipsis" seq="8" name="customerid"
                                placeholder="Customer search"
                ...
                <button type="submit" seq="10" class="btn btn-primary enterseq">Create</button>
            </form>
        </div>
    </div>
@endsection
            ...
            $j("#pwspgappform").validate({
                ...
                messages: {
                    ...
                    password: {
                        ...
                        maxlength:"The description should be 30 characters long"
                    },
                    mob_pho: {
                    ...
                    switch(keycode) {
                        case 13:
                            if($j(this).is("input") && $j(this).attr("name")=="username"){
                                ...
                                js_add_customer($j('.customerAutoSelect').find(":selected").val(),$j('.customerAutoSelect').find(":selected").text());
                                $j("#vpnaddress").html('')
                                return false;
