...
@section('content')
    <div class="container-fluid">
        <div class="container">
            ...
            <form id="termform" method="post" action="{{ url('terms') }}" >
                @csrf

                <div class="row form-group">
                    <div class="col-3">
                        <label for="term">Term:</label>
                        <input type="text" seq="1" class="form-control enterseq" id="term" name="term" maxlength="20" value="{{ old('term') }}" />
                ...
                <div class="row form-group">
                    <div class="col-3">
                        ...
                        <input type="text" seq="3" class="form-control enterseq" name="termdays" maxlength="11" value="{{ old('termdays') }}" />
