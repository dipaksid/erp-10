...
@section('content')
    <div class="container-fluid">
        <div class="">
            ...
            <form id="categoryform" method="post" action="{{ action('App\Http\Controllers\CustomerCategoriesController@update', $customercategory->id) }}" >
                @csrf
                @method('PATCH')
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="1" class="form-control enterseq" name="categorycode" value="{{$customercategory->categorycode}}" maxlength="20" />
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="2" class="form-control enterseq" name="description" value="{{$customercategory->description}}" maxlength="200" />
                ...
                <div class="row form-group">
                    <div class="col-9">
                        <label for="lastrunno">Last Running Serial Number:</label>
                        <input type="text" seq="3" class="form-control enterseq" name="lastrunno" value="{{$customercategory->lastrunno}}" maxlength="10"/>
                ...
                <div class="row form-group">
                    <div class="col-9">
                        ...
                        <input type="text" seq="4" class="form-control enterseq" name="b_rmk" value="{{$customercategory->b_rmk}}" maxlength="1"/>
                ...
                <div class="row form-group">
                    <div class="col-9">
                        ...
                        <input type="text" seq="5" class="form-control enterseq" name="b_mobapp" value="{{$customercategory->b_mobapp}}" maxlength="1"/>
                ...
                <div class="row form-group">
                    <div class="col-9">
                        ...
                        <input type="text" seq="6" class="form-control enterseq" name="b_adrmk" value="{{$customercategory->b_adrmk}}" maxlength="1"/>
                ...
                <div class="row form-group">
                    <div class="col-9">
                        ...
                        <select class="form-control enterseq" seq="7" name="stockcatgid">
                            ...
                            @foreach ($stockCategories as $id => $rcatg)
                                <option value="{{$id}}" {{ (($id==$customercategory->stockcatgid)?"selected":"") }}>{{$rcatg}}</option>
                            @endforeach
                        </select>
                ...
                <button type="submit" seq="8" class="btn btn-primary enterseq">Update</button>
            </form>
        </div>
    </div>
@endsection
