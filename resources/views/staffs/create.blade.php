...
@section('content')
    <div class="container-fluid">
        <div>
            ...
            <form id="staffform" method="post" action="{{ url('staffs') }}" >
                @csrf

                <div class="row form-group">
                    <div class="col-3">
                        <label for="staffcode">Staff Code:</label>
                        <input type="text" seq="1" class="form-control enterseq" id="staffcode" name="staffcode" value="{{old('staffcode')}}" maxlength="10"/>
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="2" class="form-control enterseq" name="name" value="{{old('name')}}" maxlength="60"/>
                    ...
                    <div class="col-6">
                        ...
                        <select seq="3" class="form-control enterseq" required id="comp_id" name="comp_id">
                            ...
                            @foreach($comp_setting as $ckey => $crow)
                                <option value="{{$crow->id}}"> {{$crow->companyname}} ({{$crow->companycode}})</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="4" class="form-control enterseq" name="designation" value="{{old('designation')}}" maxlength="20"/>
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="5" class="form-control enterseq" name="department" value="{{old('department')}}" maxlength="20"/>
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="6" class="form-control enterseq" name="date_join" value="{{old('date_join')}}" maxlength="10"/>
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="11" readonly class="form-control enterseq" name="last_review" value="{{old('last_review')}}" maxlength="10"/>
                ...
                <div class="row form-group">
                    <div class="col-3">
                        ...
                        <input type="text" class="form-control enterseq" seq="7" name="commrate" value="{{old('commrate')}}" maxlength="8" />
                        <span class="text-danger">{{ $errors->first('commrate') }}</span>
                    </div>
                </div>
