...
@section('content')
    <div class="container-fluid">
        <div>
            ...
            <form id="bankform" method="post" action="{{ action('App\Http\Controllers\BanksController@update', $bank->id) }}" >
                @csrf
                @method('PATCH')
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="1" class="form-control enterseq" name="code" value="{{$bank->code}}" maxlength="20" />
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="2" class="form-control enterseq" name="name" value="{{$bank->name}}" maxlength="200" />
