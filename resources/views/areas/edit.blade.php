...
@section('content')
    <div class="container-fluid">
        <div class="container">
            ...
            <form id="areaform" method="post" action="{{action('App\Http\Controllers\AreasController@update', $area->id)}}">
                @csrf
                @method('PATCH')
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="1" class="form-control enterseq" name="areacode" value={{$area->areacode}} maxlength="2" />
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="2" class="form-control enterseq" name="description" value={{$area->description}} maxlength="200" />
                ...
                <div class="row form-group">
                    <div class="col-3">
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="isactive" name="isactive" {{(($area->isactive=='1')?"checked":"")}}>
