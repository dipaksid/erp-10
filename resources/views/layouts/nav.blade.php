    ...
    <li class="nav-item">
        ...
        <div id="collapseMaintenance" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                @can('SERVICES RATE PROFILE LIST') <a class="collapse-item" href="{{ route('services_rates.index') }}">Services Rate Profile</a> @elsecan('ADD SERVICES RATE PROFILE') <a class="collapse-item" href="{{ route('services_rates.create') }}">Services Rate Profile</a> @endcan
