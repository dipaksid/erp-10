...
@section('content')
    <div class="container-fluid">
        ...
        <form id="categoryform" method="post" action="{{ action('App\Http\Controllers\StockCategoriesController@update', $stockcategory->id) }}" >
            @csrf
            @method('PATCH')
            ...
            <div class="row form-group">
                <div class="col-3">
                    ...
                    <input type="text" seq="1" class="form-control enterseq" name="categorycode" value="{{$stockcategory->categorycode}}" maxlength="20" />
            ...
            <div class="row form-group">
                <div class="col-3">
                    ...
                    <input type="text" seq="2" class="form-control enterseq" name="description" value="{{$stockcategory->description}}" maxlength="100" />
            ...
            <div class="row form-group">
                <div class="col-3">
                    ...
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="isshowdb" name="isshowdb" {{(($stockcategory->isshowdb=='1')?"checked":"")}}>
            ...
            <div class="row form-group">
                <div class="col-3">
                    ...
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input" id="isactive" name="isactive" {{(($stockcategory->isactive=='1')?"checked":"")}} >
