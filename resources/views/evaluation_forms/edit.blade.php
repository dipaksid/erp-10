    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <form id="trainingform" method="post"
                  action="{{action('App\Http\Controllers\EvaluationFormsController@update', $evaluation_form->id)}}">
                @csrf
                @method('PATCH')
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control enterseq" seq="2" name="form_title"
                               value="{{$evaluation_form->form_title}}" id="form_title">
                    ...
                    <div class="col-3">
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="status"
                                   name="status" {{(($evaluation_form->status=='1')?"checked":"")}}>
                                        ...
                                        <th class="col-sm-1">
                                            <div class="custom-control custom-switch">
                                                ...
                                                <input type="checkbox" class="custom-control-input enterseq" seq="103"
                                                       title="Input" id="detail_input_flag" name="detail_input_flag">
                                                <label class="custom-control-label" title="Input"
                                        ...
                                        <th class="col-sm-2">
                                            <div class="custom-control custom-switch">
                                                ...
                                                <input type="checkbox" class="custom-control-input enterseq" seq="104"
                                                       id="spacefield_detail" name="spacefield_detail">
                                                <label class="custom-control-label"
                                                       for="spacefield_detail">AllowSpace</label>
                                            </div>
                                        </th>
                                        <th>
                    ...
                    if (json.msg == "success") {
                        ...
                        if (Object.keys(json.datalist).length > 0) {
                            ...
                            $.each(json.datalist, function (i, v) {
                                ...
                                tr += "<td class=\"col-sm-3\" scope=\"col\"><input name=\"d_subject_title[" + num + "]\" class=\"form-control enterseq\" type=\"text\" value=\"" + no + "\" ><p><input name=\"detid[]\" type=\"hidden\" value=\"\" ><input name=\"stockid[]\" type=\"hidden\" value=\"\" ></p></td>";
                                tr += "<td class=\"col-sm-7\"><input class=\"form-control enterseq\" id=\"d_description\" name=\"d_description[" + num + "]\" type=\"text\" value=\"" + v.form_detail + "\" ></td>";
                                tr += "<td class=\"col-sm-1\"><input type=\"text\" class=\"form-control enterseq d_max_rating\"  onKeyPress=\"return validatenumber_c1(this, event);\" id=\"d_max_rating_" + num + "\" name=\"d_max_rating[" + num + "]\" value=\"" + v.max_rating + "\" /><input type=\"hidden\" name=\"d_id[" + num + "]\" value=\"" + v.id + "\" /></td>";
