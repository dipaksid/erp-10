            ...
            <form id="addtrainingform" method="post" action="{{url('evaluation-forms')}}">
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control enterseq" seq="2" required name="form_title" id="form_title" value="{{ old('form_title') }}">
                    </div>
                </div>
                ...
                <table class="table">
                    ...
                    <tr class="d-flex">
                        <th scope="col" class="editnum col-sm-3"><input type='text' name='subject_title' id="subject_title"  seq="3" class="form-control enterseq"></th>
                        <th class="col-sm-7"><input type='text' name='description' id="description"  seq="4" class="form-control enterseq"></th>
                        <th scope="col" class="editnum col-sm-1"><input type='text' min="0" name='max_rating' onKeyPress="return validatenumber_c1(this, event);" id="max_rating"  seq="5" class="form-control enterseq"></th>
                        <th><button type="button" class="btn btn-info enterseq" seq="6" id="addfield" name="addfield">Add</button></th>
                        <th>&nbsp;</th>
                    </tr>
                    <tr class="d-flex">
