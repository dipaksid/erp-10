...
@section('content')
    <div class="container-fluid">
        <div>
            ...
            <form id="solutionform" method="post" action="{{ url('solutionprofile') }}" >
                @csrf

                <div class="row form-group">
                    <div class="col-6">
                        <label for="areacode">Solution Code:</label>
                        <input type="text" seq="1" class="form-control enterseq" id="solutioncode" value="{{$solutionprofile->solutioncode}}" disabled name="solutioncode" maxlength="10"/>
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" seq="2" class="form-control enterseq" name="problem_description" value="{{$solutionprofile->problem_description}}" disabled maxlength="100"/>
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <textarea class="form-control enterseq" name="problem_solution" id="modal_note" seq="3"  rows="20" disabled cols="100">{{$solutionprofile->problem_solution}}</textarea>
                ...
                <div class="row form-group">
                    <div class="col-3">
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="active" {{(($solutionprofile->active=='1')?"checked":"")}} disabled name="active">
    ...
    <script type="text/javascript">
        ...
        if ($j("#solutionform").length > 0) {
            $j("#solutionform").validate({
                ...
                messages: {
                    solutioncode: {
                        required: "Please enter solution code",
                        maxlength: "Your code maxlength should be 10 characters long.",
