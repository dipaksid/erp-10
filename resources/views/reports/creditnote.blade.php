...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Credit Note Report</h1>
        </div>
        <!-- Page Heading End -->
        ...
        <div class="container">
            ...
            <form id="reportform" method="post" action="{{url('report/creditnote')}}" target="_blank">
                @csrf

                <div class="row form-group">
                    <div class="col-3">
                        <label for="title">Credit Note Date From:</label>
                ...
                <div class="row form-group">
                    <div class="col-3">
                        <label for="title">Credit Note Date To:</label>
