                ...
                <div class="row form-group">
                    <div class="col-3">
                        ...
                        <input type="text" class="form-control enterseq" placeholder="dd/mm/yyyy" name="datfr" seq="1"
                               value="{{ (isset($data['login_date'])) ? $data['login_date'] : old('datfr') ?? null }}"/>
                    </div>
                    <div class="col-3">
                    </div>
                </div>
                        ...
                        <select class="form-control enterseq" seq="3" name="area">
                            ...
                            @if(isset($data["area"]))
                                @foreach ($data["area"] as $rarea)
                                    <option value="{{ $rarea['areacode'] }}" {{ old('area') == $rarea['areacode'] ? 'selected' : ''  }}>
                                        {{$rarea['description']}}
                                    </option>
                                @endforeach
                            @endif
                ...
                <div class="row form-group">
                    <div class="col-3">
                        ...
                        <select class="form-control enterseq" seq="4" name="det_sum">
                            <option value="D" {{ old('det_sum') == "D" ? 'selected' : ''  }}>Detail</option>
                            <option value="S" {{ old('det_sum') == "S" ? 'selected' : ''  }}>Summary</option>
                        </select>
                    </div>
                    <div class="col-3">
                    </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $j(document).ready(function (evt) {
            ...
            $j('.customerfromAutoSelect').select2({
                data: customers,
