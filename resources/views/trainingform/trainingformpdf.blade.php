              ...
              <tbody>
                ...
                @php
                  ...
                  <tr>
                    ...
                    <td style="word-break: break-all; {{$space}}"><span style="{{$txtcolor}}">{{$row['particular']}}</span></td>
                   ...
                   @if(isset($detailextra) && $detailextra->count()>0)
                      @foreach($detailextra as $xkey => $extra)
                        ...
                        <tr>
                          ...
                          <td style="word-break: break-all; {{$spaceextra}}"><span style="{{$txtcolorextra}} ">{{$extra->particular}}</span></td>
                          <td style="word-break: break-all;"></td>
                          <td style="word-break: break-all;"></td>
                        </tr>
                        @endif
