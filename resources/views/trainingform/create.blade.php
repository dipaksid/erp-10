            ...
            <form id="addtrainingform" method="post" action="{{ url('trainingform') }}">
                    ...
                    <div class="col-6">
                        ...
                        <select class="form-control enterseq" seq="1" name="systemcod" id="systemcod">
                            ...
                            @foreach($data['customercategory'] as $ckey => $rowcat)
                                <option value="{{$rowcat['categorycode']}}">{{$rowcat['categorycode']}}
                ...
                <div class="row form-group">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control enterseq" seq="2" name="form_title" id="form_title">
                    </div>
                </div>
                <table class="table">
                    <thead class="thead-light">
                    <tr class="d-flex">
                        <th scope="col" class="editnum col-sm-1"><input type='text' name='no' id="no" seq="3"
                        ...
                        <th class="col-sm-1">
                            <div class="custom-control custom-switch">
                                ...
                                <input type="checkbox" class="custom-control-input enterseq" seq="5" id="specialfield"
                                       name="specialfield">
                        ...
                        <th class="col-sm-1">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input enterseq" seq="6" id="input_flag"
                                       name="input_flag">
                        ...
                        <th class="col-sm-1">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input enterseq" seq="7" id="spacefield"
                                       name="spacefield">
                                <label class="custom-control-label" for="spacefield">Allow Space</label>
                            </div>
                        </th>
                        <th>
                            <button type="button" class="btn btn-info enterseq" seq="8" id="addfield" name="addfield">
                                Add
                            </button>
                        </th>
                        <th>&nbsp;</th>
                                    ...
                                    <tr class="d-flex">
                                        ...
                                        <th class="col-sm-5">
                                            <input type='text' name='description_detail' id="description_detail"
                                                   seq="101" class="form-control enterseq">
                                        </th>
                                        <th class="col-sm-2">
                                            <div class="custom-control custom-switch">
            ...
            if ($j("input[name='description']").val() != "") {
                ...
                if (isNaN(parseInt(editnum, 10))) {
                    ...
                    var newrow = $j('<tr>').addClass("d-flex").attr("id", "inputFormRow")
                        ...
                        .append($j('<td>').addClass("col-sm-2")).append($j("<input>").attr("name", "d_specialfield[" + seq_field + "]").attr("type", "hidden").val(special_field)).append($j("<input>").attr("name", "d_spacefield[" + seq_field + "]").attr("type", "hidden").val(spacefield))
                        .append($j('<td>').addClass("col-sm-1")).append($j("<input>").attr("name", "d_input_flag[" + seq_field + "]").attr("type", "hidden").val(input_flag))
                        //  .append($j('<td>').addClass("col-sm-1").append($j("<input>").attr("name","d_rate[]").attr("type","hidden").val($j("input[name='rate']").val())).append( $j("<span>").append(get_rate)))
