...
@section('content')
    <div class="container-fluid">
        ...
        <form id="permissionform" method="post" action="{{ action('App\Http\Controllers\PermissionsController@update', $permission->id) }}">
            @csrf
            @method('PATCH')
            <div class="row form-group">
                <div class="col-3">
                    <label for="name">Name:</label>
                    <input type="text" seq="1" class="form-control enterseq" name="name" value="{{ $permission->name }}" maxlength="100" />
